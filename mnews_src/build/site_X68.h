 ...
 *  Sub system  : Site depend define [for X680x0 only]
 *  File        : site_X68.h
 *  Version     : 1.21
 *
 *  NOTE:
 *   This file is used for X680x0 only.
 *
 */
...
#define	ORGAN_FILE		"C:/usr/lib/news/organization"
...
#define	ORGAN_FILE		"C:/usr/lib/news/organ.def"
#define	CONFIG_FILE		"_mnews_setup"
#ifdef	USE_NEWS_AUTH
...
#define	EDITOR_COMMAND	"emacs"
#define	SEND_COMMAND	""
#define	POST_COMMAND	""
#define	LPR_COMMAND	""
#define	MH_COMMAND_PATH	""
#define	JNAMES_DB	"C:/usr/local/lib/jnames"
#define	NEWS_SPOOL	"C:/usr/spool/news"
#define	NEWS_LIB	"C:/usr/lib/news"
...
#define	JPEG_COMMAND	"jpeged"
#define	GIF_COMMAND	"gif"
#define	AUDIO_COMMAND	""
#define	PS_COMMAND	"gs"
