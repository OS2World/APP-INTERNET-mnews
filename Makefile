...
LIB_DIR		= d:\usr\local\lib
MAN_DIR		= d:\usr\local\man

NET_OPT		= -DNNTP -DNSPL -DSMTP -DMTAP -DPOP3
CONS_OPT	= -DNEWSPOST -DMAILSEND -DUCBMAIL -DMIME -DFCC -DJNAMES -DPAGER
CONF_OPT	= -DCTRL_L -DLARGE -DDISPLAY_CTRL -DUSE_LONG_FNAME -DRECOVER_SUBJECT -DXOVER -DCOMPLETION -DTRI -DREF_SORT
SRC_DIR		= ../src
COMPAT_DIR	= ../compat
TCP_DIR		= ../tcplib
NNTP_DIR	= ../nntplib
